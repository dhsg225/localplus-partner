...
const MediaPicker: React.FC<MediaPickerProps> = ({
    ...
    const handleDelete = async (e: React.MouseEvent, mediaId: string, filename: string) => {
                                            ...
                                            {mediaItems.map((item) => (
                                                ...
                                                >
                                                    ...
                                                    <button
                                                        ...
                                                        className="absolute top-2 right-2 p-1.5 bg-red-600 text-white rounded-full opacity-0 group-hover:opacity-100 hover:bg-red-700 transition-opacity shadow-lg"
                                                        title="Delete image"
                                                    >
